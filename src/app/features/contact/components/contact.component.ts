...
export class ContactComponent implements OnInit {
  ...
  socialLinks: any = [
    ...
    { name: 'yovanysuarezsilva@gmail.com', url: '/assets/pdf/CV_es_Yovany_Suarez_Silva_2025_FullStack.pdf', icon: null },
    { name: 'Download CV', url: '/assets/pdf/CV_es_Yovany_Suarez_Silva_2025_FullStack.pdf', icon: null }
  ];
